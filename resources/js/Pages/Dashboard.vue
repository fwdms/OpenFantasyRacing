      ...
      <div class="mx-auto my-4 mx-6">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto px-2">
            <h1 class="text-xl font-semibold text-gray-900">Fantasy Teams</h1>
        ...
        <div v-if="fantasy_teams.length === 0">
          ...
          >
            Currently, you aren't part of any leagues. Maybe, you should create
            one?
          </p>
        </div>
      </div>
