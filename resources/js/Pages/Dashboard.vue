        ...
        <template v-slot:top>
            <div class="mx-6 my-4">
                ...
                <div v-if="fantasy_teams.length === 0">
                    <p
                        class="mx-auto w-full whitespace-nowrap bg-white py-4 text-center text-sm font-medium text-gray-900 sm:pl-6"
                    >
                        Currently, you aren't part of any leagues. Maybe, you
                        should create one?
                    </p>
                </div>
            </div>
        ...
        <tr class="text-center" v-for="team in fantasy_teams" :key="team.id">
            ...
            >
                <Link
                    class="text-blue-600"
                    :href="
                        route('fantasy-team.show', [team.league_id, team.id])
                    "
                >
                    {{ team.team_name }}
                </Link>
...
<script setup>
    ...
    const headers = ['Fantasy Team Name', 'League Name', 'Franchise', 'Points']
