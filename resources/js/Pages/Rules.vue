<template>
  ...
  <points-table
    ...
    :points="racePoints"
    notes="* Race Positions Gained: Race positions gained are relative to Qualifying finishing position or Sprint finishing position
                where applicable.
...
<script setup>
  ...
  import PointsTable from '@/Shared/Tables/PointsTable.vue'
  ...
  const tabs = ['Scoring Points', 'Rules']
</script>
