<template>
  ...
  <div class="flex flex-wrap bg-white mx-8 py-8 px-8 rounded my-8">
    <img
      class="max-w-md w-full mx-auto object-center object-cover rounded"
      :src="
    ...
    <div class="mx-auto mt-8 xl:mt-0 xl:w-4/6">
      <h1
        class="text-3xl font-extrabold tracking-tight text-gray-900 text-center xl:text-left"
      >
  ...
  >
    ...
    >
      <td
        class="whitespace-nowrap py-4 w-96 pl-4 pr-3 text-center text-sm font-medium text-gray-900 sm:pl-6"
      >
        {{ result.round_number }}
      </td>
      <td
