      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex-shrink-0 flex items-center">
            <Link href="/">
              <!-- The Logo -->
              <p class="text-orange-600 font-semibold sm:text-xl md:text-2xl" style="font-family: 'Bangers', cursive;">
                {{ appName }}
              </p>
            ...
            >
              <MenuItems class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                <MenuItem v-slot="{ active }">
                  <a href="https://www.patreon.com/openfantasyracing" target="_blank" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700 w-full']">
                    Donate
                  </a>
                </MenuItem>
                <MenuItem v-slot="{ active }">
