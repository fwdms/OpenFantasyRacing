  ...
  <footer class="bg-gray-800">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <div class="mt-8 flex justify-center space-x-6">
        <Link href="https://twitter.com/karlcodeswell" class="text-gray-400 hover:text-gray-500" target="_blank">
          <span class="sr-only">Twitter</span>
          <svg class="text-gray-500 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
